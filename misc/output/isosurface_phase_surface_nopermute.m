function isosurface_phase_surface_nopermute( obj, params )
...
%     ylabel( '+y', 'fontweight', 'bold', 'fontsize', 16 ); ylim( [ min(params.z_coord_length), max(params.z_coord_length) ])
%     zlabel( '+z', 'fontweight', 'bold', 'fontsize', 16 ); zlim( [ min(params.y_coord_length), max(params.y_coord_length) ])
