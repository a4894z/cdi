...
clear; close all; testing_mb005_rPIE_vs_alpha

%}

rootpath_data = '/net/s8iddata/export/8-id-ECA/Analysis/atripath/minibatch_vs_stoch_vs_full_rPIE_alpha/mb0p005/';

path_data = {};
N_trials  = [];

path_data{ end + 1 } = [ rootpath_data, '/cdi_rPIE_mb0p005_alpha0p01/independenttrials_24Aug2021_t083220/' ];
N_trials( end + 1 )  = 10;

path_data{ end + 1 } = [ rootpath_data, '/cdi_rPIE_mb0p005_alpha0p05/independenttrials_08Sep2021_t114323/' ];
N_trials( end + 1 )  = 10;

path_data{ end + 1 } = [ rootpath_data, '/cdi_rPIE_mb0p005_alpha0p10/independenttrials_10Sep2021_t052647/' ];
N_trials( end + 1 )  = 10;

path_data{ end + 1 } = [ rootpath_data, '/cdi_rPIE_mb0p005_alpha0p20/independenttrials_11Sep2021_t222249/' ];
N_trials( end + 1 )  = 10;

path_data{ end + 1 } = [ rootpath_data, '/cdi_rPIE_mb0p005_alpha0p40/independenttrials_13Sep2021_t143455/' ];
N_trials( end + 1 )  = 10;
