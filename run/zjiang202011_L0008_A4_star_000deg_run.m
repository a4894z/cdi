...
% clear; close all; zjiang202011_L0008_A4_star_000deg_run
...
[ expt.paths ] = zjiang202011_L0008_A4_star_000deg_paths( expt.paths ); 
...
%     expt.paths.rdatah5 = '/home/8ididata/2020-3/zjiang202011/reduced_data/Avg_L0002_apslogo_200nm_0001.h5';
    ...
    [ sol, expt ] = zjiang202011_L0008_A4_star_000deg_setup( expt );              % ***** Create ***** processed data:
...
[ sol, expt ] = zjiang202011_L0008_A4_star_000deg_defaults( sol, expt );
...
function [ sol, expt ] = zjiang202011_L0008_A4_star_000deg_defaults( sol, expt )     
    ...
    sol.it.probe_start   = 200;
    sol.it.probe_update  = 10;
...
%     sol.probe.scpm.fro2TOT = [];
    sol.probe.scpm.fro2TOT = 50.00 * mean( expt.meas.SI_sumD2 );
...
%     sol.probe.P = enforce_scpm_fro2TOT_photonocc( sol.probe.P, sol.probe.scpm.fro2TOT, sol.probe.scpm.occ );
    ...
    sol.probe.support = 0 + 1 * make_rectangle( sol.sz.sz, [ 0.6 * sol.sz.r, 0.6 * sol.sz.c ]);
...
function [ paths ] = zjiang202011_L0008_A4_star_000deg_paths( paths )

    %==================
    % read hdf5 data path
    
%     paths.rdatah5 = '/home/ash/Desktop/reduced_data/Avg_L0008_A4_star_000deg_0001.h5';
    paths.rdatah5 = '/media/ash/Saltwater/Data/experimental/zjiang202011/cssi/reduced_data/Avg_L0008_A4_star_000deg_0001.h5';
